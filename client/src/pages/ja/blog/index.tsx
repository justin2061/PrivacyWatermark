...
const articles: Article[] = [
  {
    ...
    title: "マイナンバーカードのコピーを悪用させない透かしの入れ方",
    excerpt:
      "マイナンバーカードのコピーが悪用されると、口座開設やローン申請、携帯回線の不正契約に使われます。提出先・用途・日付の透かしで悪用の余地を潰す3ステップと、銀行・携帯・不動産・入社時・フリーランスの実務ごとの判断を整理しました。",
    date: "2026-08-17",
    category: "使い方",
  },
  {
    slug: "passport-copy-privacy-guide",
    title: "パスポートのコピーをメールで送るのは安全？",
    excerpt:
      "旅券番号・自署・MRZまで写り込む一枚をメール添付する前にできる4つの対策——透かし・マスキング・EXIF削除・海外滞在中の扱い方——を、海外KYCや紛失時の対応まで含めて整理しました。",
    date: "2026-08-17",
    category: "プライバシー",
  },
  {
