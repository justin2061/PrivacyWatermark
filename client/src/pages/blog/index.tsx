...
const articles = [
  ...
  },
  {
    ...
    title: "證件影本加浮水印教學：3 步驟完成，手機電腦都適用",
    date: "2026-07-11",
    summary:
      "證件浮水印怎麼加？什麼是證件浮水印、為什麼重要、3 步驟實際做一次，再教 Logo 浮水印與馬賽克遮蔽的進階搭配。附常見問題 FAQ。",
  },
  {
  ...
  },
  {
    ...
    title: "租屋身分證影本加註怎麼寫？「僅供租屋使用」浮水印範例",
    date: "2026-04-06",
    summary:
      "房東或仲介要身分證影本，加註怎麼寫才安全？房東／仲介／包租代管三種對象的寫法差異、「僅供租屋使用」浮水印範例，以及 3 步驟用 ImageMarker 完成。",
  },
  {
  ...
  },
  {
    ...
    title: "身分證影本簽註寫法完整範本 — 20 組常見場景可直接複製",
    date: "2026-08-27",
    summary:
      "租屋、開戶、求職、入職、實名認證……20 組寫好的簽註文字，一鍵複製就能貼上，日期自動帶今天。附通用公式與 4 步驟做成證件浮水印。",
  },
  {
    slug: "watermark-templates-guide",
    title: "身分證影本簽註寫法＋加註位置：10 種情境範本與證件浮水印範例（2026）",
    date: "2026-04-16",
    summary:
      "簽註要寫什麼、加註位置該放在證件哪個部位才不會被裁掉、正反面要不要各簽一次？完整規則＋租屋、求職、開戶等 10 種情境範本直接套用。",
  },
  {
