          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
                <span className="text-white text-lg" role="img" aria-label="PDF 浮水印">
                  📄
                </span>
              </div>
              <div>
                <h1 className="text-xl font-semibold text-gray-900">PDF 浮水印工具</h1>
                <p className="text-xs text-gray-600">安全的本地端 PDF 處理</p>
              </div>
            </Link>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="bg-blue-50 border-blue-200 p-4 mb-8">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="font-medium text-blue-900 mb-1">為什麼用這個 PDF 浮水印工具？</h2>
              <p className="text-sm text-blue-800">
                需要在合約、報價單、證件掃描檔或機密文件上標註用途、防止盜用時，PDF 浮水印非常實用。
                本工具完全在你的瀏覽器中以 pdf-lib 處理，PDF 不會上傳到任何伺服器，沒有檔案大小限制，也不會留下任何副本。
              </p>
            </div>
          </div>
        </Card>
